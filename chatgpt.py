...
HELP_BACK = [
     [
           InlineKeyboardButton(text="Qᴜᴇꜱᴛɪᴏɴ ᴛʜᴀᴛ ᴄʜᴀᴛɢᴘᴛ ᴄᴀɴ ꜱᴏʟᴠᴇ ", url=f"https://t.me/Privates_RoBot"),
...
if SOURCE != s:
    print("So sad, you have changed source, change it back to ` https://t.me/Privates_RoBot `  else I won't work")
    sys.exit(1)  
